    ...
    <div class="news-container">
        <div class="news-banner-container">
            ...
            <div class="news-heading-container">
                <span class="news-date"><b>Posted On:</b> <?php echo get_the_date('F j, Y') ?></span>
                <span class="news-author">
                    <svg width="18" height="20" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      By <?php echo get_the_author_meta('display_name', get_post_field( 'post_author', get_the_ID())); ?>
                </span>
                <h1 class="post-title"><?php echo the_title() ?></h1>
                <p class="expert-text"><?php echo $post->post_excerpt ?></p>
            </div>
        </div>
