...
<div class="location-wrapper">
    <div class="location" style="background-image: url(<?php echo $image_background['url'] ?>);">
        <div class="location-content" style="background-color: <?php echo $background_color ?>;">
        <span class="sub-heading"><?php echo $sub_heading ?></span>
        <h2 class="heading"><?php echo $heading ?></h2>
        <p class="text"><?php echo $text ?></p>
        <div class="list-address">
            <?php 
            if(!$address): else: foreach($address as $item){
            ?>
