...
?>
<div class="testimonial-wrapper" style="background-image: url(<?php echo $bg_image['url'] ?>);">

    <!-- <img src="" class="background-image" alt="" srcset=""> -->
    <div class="content">
                            ...
                            <div class="carousel-item active">
                                <div class="testimonial-content">
                                    <div class="customer-image">
                                        <img src="<?php echo $item['customer_image']['url'] ?>" alt="">
                                    </div>
